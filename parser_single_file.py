...
location = r'C:\Users\timothy\Python_converter\ragtime.mxl'
...
def musicxml2df(filepath):
    ...
    #filename = re.search(composer+'\\\(.*)\.', filepath).group(1)000
    filename = 'hello'
...
musicxml2df(location).to_csv('ragtime.csv', sep=',')